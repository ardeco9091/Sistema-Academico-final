...
def test_procesar_orden_y_campos():
    estudiantes = [
    {"nombre": "Ana", "apellido": "García", "dni": "123", "edad": 20, "notas": [9, 8, 10], "email": "ana@example.com"},
    {"nombre": "Luis", "apellido": "Pérez", "dni": "456", "edad": 22, "notas": [6, 7, 5], "email": "luis@example.com"},
    {"nombre": "Marta", "apellido": "López", "dni": "789", "edad": 21, "notas": [10, 9, 9], "email": "marta@example.com"}
]
